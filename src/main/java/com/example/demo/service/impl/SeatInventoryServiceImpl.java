...
public class SeatInventoryServiceImpl implements SeatInventoryService {
    ...
    public SeatInventoryRecord createInventory(SeatInventoryRecord inventory) {
        ...
        // ✅ Null checks
        if (inventory.getTotalSeats() == null || inventory.getRemainingSeats() == null) {
            throw new BadRequestException("Total seats and remaining seats are required");
        }
        ...
        if (inventory.getEventId() == null ||
                !eventRecordRepository.existsById(inventory.getEventId())) {
            throw new NotFoundException("Event not found with id: " + inventory.getEventId());
        }
    ...
    public SeatInventoryRecord getInventoryByEvent(Long eventId) {
        return seatInventoryRecordRepository.findByEventId(eventId)
                .orElseThrow(() ->
                        new NotFoundException("Seat inventory not found for event: " + eventId));
    }
    ...
    public SeatInventoryRecord updateInventory(Long eventId, Integer remainingSeats) {
        ...
        if (remainingSeats == null) {
            throw new BadRequestException("Remaining seats is required");
        }
